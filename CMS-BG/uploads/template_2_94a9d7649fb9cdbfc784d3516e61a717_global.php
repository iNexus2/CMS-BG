...
CONTENT;
	...
	function error( $title, $message, $code, $backtrace ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= <<<CONTENT
	...
	<pre>
CONTENT;
$return .= htmlspecialchars( $backtrace, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
</pre>
...
if ( (\IPS\Theme::i()->settings['ipsf_headerScripts']) AND (\IPS\Theme::i()->settings['js_include'] != 'footer')  ):
$return .= <<<CONTENT

CONTENT;

$return .= \IPS\Theme::i()->settings['ipsf_headerScripts'];
$return .= <<<CONTENT
...
$return .= \IPS\Settings::i()->base_url;
$return .= <<<CONTENT
' id='elSiteTitle' accesskey='1' class='logo textLogo ipsResponsive_hideDesktop ipsResponsive_block'><span class='vAlign'>
CONTENT;
...
if ( !\IPS\Theme::i()->settings['singleNavigationBar'] ):
$return .= <<<CONTENT
data-controller='core.front.core.navBar'
CONTENT;
