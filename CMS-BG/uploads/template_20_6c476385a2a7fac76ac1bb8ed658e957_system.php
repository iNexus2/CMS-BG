...
$return .= <<<CONTENT
	...
	<div class="ipsPos_right">
<a class="ipsButton ipsButton_negative ipsButton_verySmall clearNotifications Notifications_main" href="
CONTENT;
...
CONTENT;
	...
	function securityAnswersResetConfirm( $message ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "global", \IPS\Request::i()->app )->pageHeader( \IPS\Member::loggedIn()->language()->addToStack('security_questions') );
$return .= <<<CONTENT
...
CONTENT;
	...
	function securityQuestionsFail( $link ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'security_questions_fail_blurb', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</p>
<a href="
CONTENT;
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'reset_security_answers', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a>
CONTENT;
	...
	function securityQuestionsFinished(  ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'security_questions_setup_done', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</p>
CONTENT;
	...
	function securityQuestionsForm( $form ) {
		$return = '';
		$return .= <<<CONTENT
...
CONTENT;
	...
	function securityQuestionsSetup( $form, $isManualConfiguration ) {
		$return = '';
		$return .= <<<CONTENT
...
CONTENT;
	...
	function settings( $tab, $output, $canChangeEmail, $canChangePassword, $canChangeUsername, $canChangeSignature, $services,  $canConfigureMfa=FALSE ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=system&controller=settings&area=mfa", null, "settings_mfa", array(), 0 ) );
$return .= <<<CONTENT
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'ucp_mfa', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
" role="tab" aria-selected="
CONTENT;
