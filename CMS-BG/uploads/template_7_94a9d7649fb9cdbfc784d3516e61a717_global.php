...
{
	public $cache_key = 'edeec54b588ae8bdfc5cee214514e779';
...
CONTENT;
	...
	function breadcrumb( $useMicrodata=TRUE ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=system&controller=language" . "&csrfKey=" . \IPS\Session::i()->csrfKey, null, "language", array(), 0 ) );
$return .= <<<CONTENT
" method="post">
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=system&controller=theme" . "&csrfKey=" . \IPS\Session::i()->csrfKey, null, "theme", array(), 0 ) );
$return .= <<<CONTENT
" method="post">
						<button type='submit' name='id' value='
CONTENT;
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "applications/core/interface/html5shiv/html5shiv.js", "none", "", array(), 0 ) );
$return .= <<<CONTENT
"></script>
		<![endif]-->
...
if ( \IPS\Theme::i()->settings['ipsf_googleFonts'] ):
$return .= <<<CONTENT

CONTENT;

$return .= \IPS\Theme::i()->settings['ipsf_googleFonts'];
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['ipsf_backgroundType'];
$return .= <<<CONTENT
 
CONTENT;

if ( \IPS\Theme::i()->settings['ipsf_valentines'] ):
$return .= <<<CONTENT
ipsfocus_valentines
CONTENT;
...
if ( \IPS\Theme::i()->settings['ipsf_fixedHeader'] ):
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->searchBar(  );
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_backgroundType'] == 'ipsfocus_backgroundPicker' ):
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->ipsfocus_backgroundPicker(  );
endif;
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_social'] ):
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->ipsfocus_socialButtons(  );
endif;
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->utilitiesMenu(  );
$return .= <<<CONTENT

                          
CONTENT;

$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->breadcrumb( true );
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->ipsfocus_countdown(  );
endif;
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_guest'] ):
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->ipsfocus_guestMessage(  );
endif;
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_megaFooter'] ):
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->ipsfocus_megaFooter(  );
endif;
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->breadcrumb( false );
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->inlineMessage( $conversation->comments( 1, NULL, 'date', 'desc' ) );
endif;
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_backgroundType'] == 'ipsfocus_videoBackground' ):
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->ipsfocus_videoBackground(  );
endif;
$return .= <<<CONTENT
...
CONTENT;
	...
	function ipsfocus_backgroundPicker(  ) {
		$return = '';
		$return .= <<<CONTENT

<div id='ipsf_pickerWrap'>
	<div id='ipsf_picker' class='ipsClearfix'>
	    <span data-backgroundClass='ipsfocus_bg1' style='background-color: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg1_hex'];
$return .= <<<CONTENT
; background-image: url(
CONTENT;

$return .= \IPS\Theme::i()->resource( "backgrounds/1.jpg", "core", 'front', false );
$return .= <<<CONTENT
);'></span>
		<span data-backgroundClass='ipsfocus_bg2' style='background-color: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg2_hex'];
$return .= <<<CONTENT
; background-image: url(
CONTENT;

$return .= \IPS\Theme::i()->resource( "backgrounds/2.jpg", "core", 'front', false );
$return .= <<<CONTENT
);'></span>
    	<span data-backgroundClass='ipsfocus_bg3' style='background-color: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg3_hex'];
$return .= <<<CONTENT
; background-image: url(
CONTENT;

$return .= \IPS\Theme::i()->resource( "backgrounds/3.jpg", "core", 'front', false );
$return .= <<<CONTENT
);'></span>
	    <span data-backgroundClass='ipsfocus_bg4' style='background-color: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg4_hex'];
$return .= <<<CONTENT
; background-image: url(
CONTENT;

$return .= \IPS\Theme::i()->resource( "backgrounds/4.jpg", "core", 'front', false );
$return .= <<<CONTENT
);'></span>
	</div>
</div>
CONTENT;
	...
	function ipsfocus_countdown(  ) {
		$return = '';
		$return .= <<<CONTENT

<div class='ipsfocus_countdown'>
	<div class='title'>
CONTENT;

$return .= \IPS\Theme::i()->settings['ipsf_countdownText'];
$return .= <<<CONTENT
</div>
	<div class='ipsfocus_timer'></div>
</div>

<script type='text/javascript'>
$(document).ready(function(){
	$('.ipsfocus_countdown .ipsfocus_timer').countdown('
CONTENT;

$return .= \IPS\Theme::i()->settings['ipsf_countdownDate'];
$return .= <<<CONTENT
', function(event) {
		var ipsf_countdown = $(this).html(event.strftime(''
		+ '<span class="num">%w</span> <span class="dateType">weeks</span> '
		+ '<span class="num">%d</span> <span class="dateType">days</span> '
		+ '<span class="num">%H</span> <span class="dateType">hr</span> '
		+ '<span class="num">%M</span> <span class="dateType">min</span> '
		+ '<span class="num">%S</span> <span class="dateType">sec</span>'));
	});
});
</script>
CONTENT;
	...
	function ipsfocus_guestMessage(  ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['ipsf_guestStyle'];
$return .= <<<CONTENT
'>
	<div class="ipsfocus_guestHeader">Welcome to 
CONTENT;
...
$return .= \IPS\Theme::i()->settings['ipsf_guestText'];
$return .= <<<CONTENT
</div>
...
$return .= <<<CONTENT
" class="guestButton ipsfocus_register">
CONTENT;
...
CONTENT;
	...
	function ipsfocus_megaFooter(  ) {
		$return = '';
		$return .= <<<CONTENT

<div class='ipsfocus_megaFooter colCount
CONTENT;

$return .= \IPS\Theme::i()->settings['ipsf_footerColumns'];
$return .= <<<CONTENT
'>
...
$return .= \IPS\Theme::i()->settings['ipsf_footerOne'];
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_footerColumns'] > 1 ):
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['ipsf_footerTwo'];
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_footerColumns'] > 2 ):
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['ipsf_footerThree'];
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_footerColumns'] > 3 ):
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['ipsf_footerFour'];
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_footerColumns'] > 4 ):
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['ipsf_footerFive'];
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_footerColumns'] > 5 ):
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['ipsf_footerSix'];
$return .= <<<CONTENT
...
CONTENT;
	...
	function ipsfocus_socialButtons(  ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['ipsf_socialButton'];
$return .= <<<CONTENT
 ipsClearfix'>
...
CONTENT;
	...
	function ipsfocus_videoBackground(  ) {
		$return = '';
		$return .= <<<CONTENT

<div id='ipsfocus_videoBackground'><div id="videoiframe"></div></div>
...
$return .= \IPS\Theme::i()->settings['ipsf_videoID'];
$return .= <<<CONTENT
',
      playerVars: {
        'playlist': '
...
$(document).ready(function(){
    ...
    var ipsfocus_videoBackground = function() {
	    var browserWidth = $(window).width();
    	var videoHeight = browserWidth*0.5625;
		$("#videoiframe, #ipsfocus_videoBackground").height(videoHeight);
	};
...
if ( \IPS\Theme::i()->settings['ipsf_mobileTextLogo'] ):
$return .= <<<CONTENT
...
$return .= \IPS\Settings::i()->base_url;
$return .= <<<CONTENT
' id='elLogo' accesskey='1' class='logo justImage ipsResponsive_showDesktop'><span class='vAlign'><img src="
CONTENT;
...
$return .= \IPS\Settings::i()->base_url;
$return .= <<<CONTENT
' id='elSiteTitle' accesskey='1' class='logo textLogo ipsResponsive_hideDesktop'><span class='vAlign'>
CONTENT;
...
$return .= \IPS\Settings::i()->base_url;
$return .= <<<CONTENT
' id='elLogo' accesskey='1' class='logo justImage'><span class='vAlign'><img src="
CONTENT;
$return .= htmlspecialchars( $logo, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
" alt=''></span></a>
...
$return .= \IPS\Settings::i()->base_url;
$return .= <<<CONTENT
' id='elSiteTitle' accesskey='1' class='logo textLogo'><span class='vAlign'>
  
	
CONTENT;

if ( \IPS\Theme::i()->settings['ipsf_textLogoImage'] ):
$return .= <<<CONTENT
<img src='
CONTENT;

$return .= \IPS\Theme::i()->resource( "ipsfocus/mini_logo.png", "core", 'front', false );
$return .= <<<CONTENT
' alt='' />
CONTENT;
...
if ( \IPS\Theme::i()->settings['ipsf_slogan'] ):
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['ipsf_slogan'];
$return .= <<<CONTENT
</span></span>
CONTENT;
...
$return .= <<<CONTENT
						...
						<li data-role='navItem'>
							<a id="elNavigation_app_
CONTENT;

$return .= htmlspecialchars( strtok( $id, '_'), ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
_
CONTENT;
...
" href='
CONTENT;
$return .= htmlspecialchars( $nav->link(), ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
' class='elNavigation_app_
CONTENT;
$return .= htmlspecialchars( $id, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
...
$return .= <<<CONTENT
data-ipsMenu data-ipsMenu-activeClass='ipsNavActive_menu'
CONTENT;
...
CONTENT;
$return .= htmlspecialchars( $nav->title(), ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->navBarChildren( $children );
$return .= <<<CONTENT
...
$return .= <<<CONTENT
				...
				<li class='ipsHide cCommunityHome'><a href='
CONTENT;
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=messaging&controller=messenger&do=enableMessenger", null, "messaging", array(), 0 ) );
$return .= <<<CONTENT
' title='
CONTENT;
...
$return .= <<<CONTENT
				...
				<li class='ipsMenu_item' id='elAccountSettingsLink'><a href='
CONTENT;
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'userbar_notifications', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
...
if ( \IPS\Member::loggedIn()->notification_cnt ):
$return .= <<<CONTENT
<span class='ipsNotificationCount' data-notificationType='notify'>
CONTENT;
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'userbar_messages', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
' data-ipsMenu data-ipsMenu-closeOnClick='false'>
...
if ( \IPS\Member::loggedIn()->msg_count_new ):
$return .= <<<CONTENT
 <span class='ipsNotificationCount' data-notificationType='inbox'>
CONTENT;
...
$return .= <<<CONTENT
" class='ipsPos_right ipsButton ipsButton_primary ipsButton_verySmall'>
CONTENT;
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'userbar_reports', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
' data-ipsMenu data-ipsMenu-closeOnClick='false'>
					<i class='fa fa-warning'></i> 
CONTENT;
...
if ( (\IPS\Theme::i()->settings['ipsf_backgroundType'] === 'ipsfocus_backgroundPicker') AND \IPS\Theme::i()->settings['ipsf_guestPicker']  ):
$return .= <<<CONTENT
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=system&controller=vnc", null, "vnc", array(), 0 ) );
$return .= <<<CONTENT
' accesskey='2'><i class='fa fa-star'></i> 
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'new_content', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a></li>
...
if ( \IPS\Member::loggedIn()->canAccessModule( \IPS\Application\Module::get( 'core', 'activity' ) ) or \IPS\Settings::i()->gl_type != "none" or !\IPS\Settings::i()->staff_directory_empty or  \IPS\Settings::i()->profile_comments AND \IPS\Member::loggedIn()->canAccessModule( \IPS\Application\Module::get( 'core', 'status' ) ) or \IPS\Member::loggedIn()->canAccessModule( \IPS\Application\Module::get( 'core', 'online' ) ) ):
$return .= <<<CONTENT

			<li>
				<a href='#elNavMore_menu' id='elNavMore' data-ipsMenu data-ipsMenu-appendTo='#elHeaderSubLinks' data-ipsMenu-align-center>
CONTENT;
...
if ( \IPS\Member::loggedIn()->canAccessModule( \IPS\Application\Module::get( 'core', 'activity' ) ) ):
$return .= <<<CONTENT

			<li class='ipsMenu_item'><a href='
CONTENT;

$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=activity&controller=activity", null, "activity", array(), 0 ) );
$return .= <<<CONTENT
'>
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'activity_stream', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a></li>
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=system&controller=guidelines", null, "guidelines", array(), 0 ) );
$return .= <<<CONTENT
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'guidelines', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a></li>
...
if ( !\IPS\Settings::i()->staff_directory_empty ):
$return .= <<<CONTENT

			<li class='ipsMenu_item'><a href='
CONTENT;

$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=members&controller=directory", null, "staffdirectory", array(), 0 ) );
$return .= <<<CONTENT
'>
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'staff', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a></li>
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=status&controller=feed", null, "status", array(), 0 ) );
$return .= <<<CONTENT
'>
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'status_updates', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a></li>
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'online_users', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a></li>
...
$return .= <<<CONTENT
			...
			<li class='ipsMenu_item'><a data-action="markSiteRead" data-controller="core.front.core.markRead" href='
CONTENT;
