...
if ( (\IPS\Theme::i()->settings['jqueryCookie']) || (\IPS\Theme::i()->settings['ipsf_backgroundType'] === 'ipsfocus_backgroundPicker')  ):
$return .= <<<CONTENT

<script src='
CONTENT;

$return .= \IPS\Theme::i()->resource( "js/jquery.cookie.js", "core", 'front', false );
$return .= <<<CONTENT
'></script>
...
$return .= \IPS\Theme::i()->resource( "js/snowfall.jquery.min.js", "core", 'front', false );
$return .= <<<CONTENT
'></script>
...
$return .= \IPS\Theme::i()->resource( "js/jquery.countdown.min.js", "core", 'front', false );
$return .= <<<CONTENT
'></script>
...
$return .= <<<CONTENT
_ifbg_class',backgroundClass,{ expires: 365, path: '/'});
	});
...
$return .= \IPS\Theme::i()->settings['ipsfocus_reset'];
$return .= <<<CONTENT
' data-controller='core.front.core.poll'>
...
$return .= \IPS\Lang::wordbreak( htmlspecialchars( $poll->poll_question, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE ) );
$return .= <<<CONTENT
&nbsp;&nbsp;
			<span class='ipsType_normal ipsType_light'>sdfsdf
CONTENT;
...
$return .= \IPS\Lang::wordbreak( htmlspecialchars( $question['question'], ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE ) );
$return .= <<<CONTENT
</h3>
