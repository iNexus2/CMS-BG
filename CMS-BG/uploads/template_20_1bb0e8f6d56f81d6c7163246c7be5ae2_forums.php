...
$return .= <<<CONTENT
				...
				<div class="ipsDataItem_authorAvatar
CONTENT;

if ( !\IPS\Settings::i()->topicAuthorPosts_enableCounter ):
$return .= <<<CONTENT
 ipsDataItem_authorAvatarNoCounter
CONTENT;
...
$return .= <<<CONTENT
		...
		<span class="ipsNotificationCount" title="
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'topicAuthorAvatar_aotsp', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
" data-ipstooltip>
CONTENT;
$return .= htmlspecialchars( $row->author()->getTopicAuthorPosts($row->author()->member_id, $row->$idField), ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
</span>
