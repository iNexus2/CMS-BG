...
$return .= <<<CONTENT
				...
				<div class="ipsDataItem_meta ipsType_richText ipsContained">{$forum->description}</div>
...
$return .= \IPS\Theme::i()->getTemplate( "index", \IPS\Request::i()->app )->indexButtons(  );
$return .= <<<CONTENT
...
$return .= <<<CONTENT
				...
				<h2 class="ipsType_sectionTitle ipsType_reset ipsType_blendLinks cForumTitle">
					<a href='#' class='ipsPos_right ipsJS_show cForumToggle' data-action='toggleCategory' data-ipsTooltip title='
CONTENT;
