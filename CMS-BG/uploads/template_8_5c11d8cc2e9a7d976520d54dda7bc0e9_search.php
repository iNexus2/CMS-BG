...
$return .= <<<CONTENT
	...
	<div class='ipsPad'><div class="ipsMessage ipsMessage_info">
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'search_rebuild_is_running', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</div></div>
