...
{
	public $cache_key = 'f490296b26d714df4b3890679f3b6a7f';
	function conversation( $conversation, $folders ) {
		$return = '';
		$return .= <<<CONTENT

<div class=''>
	<p class='ipsResponsive_hideDesktop ipsResponsive_block ipsType_reset'>
...
$return .= <<<CONTENT
	...
	<div class='ipsPageHeader ipsClearfix'>
      <h1 class='ipsType_pageTitle ipsType_break ipsPos_left'>
CONTENT;
...
$return .= <<<CONTENT
	...
	<br>
	<div class=''>
		<h2 class='ipsType_sectionTitle ipsType_reset' style='display: none;'>
CONTENT;
...
$return .= <<<CONTENT
				...
				<div data-role='replyArea' class='ipsBox ipsPad'>
...
$return .= htmlspecialchars( mb_substr( html_entity_decode( $row['mt_title'] ), '0', "45" ), ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE ) . ( ( mb_strlen( html_entity_decode( $row['mt_title'] ) ) > "45" ) ? '&hellip;' : '' );
$return .= <<<CONTENT
</a>
...
<div class='ipsBox ipsPad'>
  <div class="ipsType_center ipsType_large ipsEmpty" style='padding-bottom: 30px;'>
...
$sprintf = array(\IPS\Member::load( $map['map_user_id'] )->name); $return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'messenger_map_disabled_desc', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), FALSE, array( 'sprintf' => $sprintf ) );
$return .= <<<CONTENT
' data-ipsTooltip>
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'messenger_map_disabled', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</span>
...
'>
		<div class='ipsColumn ipsColumn_veryWide' data-role='filterBar'>
			<div id='elMessageSidebar' class='ipsBox ipsfocus_reset' data-controller='core.front.messages.list' data-folderID='
CONTENT;
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=messaging&controller=messenger" . "&csrfKey=" . \IPS\Session::i()->csrfKey, null, "messaging", array(), 0 ) );
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "messaging", "core" )->messageListRows( $conversations, NULL, FALSE, $folders );
$return .= <<<CONTENT
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'messenger_move', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</option>
								</select>
...
" data-role='messageSearch' id='elMessageSearchForm'>
						<a href='#' data-action='messageSearchCancel' class='ipsHide'><i class='fa fa-times'></i></a>
                      	<a href='#elSearchTypes_menu' id='elSearchTypes' data-ipsMenu data-ipsMenu-selectable='checkbox' data-ipsMenu-appendTo='#elMessageSearchForm' data-ipsMenu-closeOnClick='false' class="ipsButton ipsButton_verySmall ipsButton_light ipsPos_right">
							<i class='fa fa-cog'></i>
						</a>
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'messenger_search_menu_title', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</li>
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'messenger_search_in_post', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a></li>
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'messenger_search_in_topic', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a></li>
							<li class='ipsMenu_item' data-ipsMenuValue='recipient'><a href='#'><input type="checkbox" name="search[recipient]" value="1" id="search_recipient"> 
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'messenger_recipient_name', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a></li>
							<li class='ipsMenu_item' data-ipsMenuValue='sender'><a href='#'><input type="checkbox" name="search[sender]" value="1" id="search_sender"> 
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'messenger_sender_name', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a></li>
						</ul>
					</form>
                  	<p class='ipsType_center ipsType_medium'>
                        <a href='
CONTENT;

$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=messaging&controller=messenger&do=disableMessenger" . "&csrfKey=" . \IPS\Session::i()->csrfKey, null, "messaging", array(), 0 ) );
$return .= <<<CONTENT
' data-confirm>
CONTENT;
...
$return .= htmlspecialchars( min( 100, 100 / \IPS\Member::loggedIn()->group['g_max_messages'] * array_sum( $counts ) ), ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
%'></span></span><br>
