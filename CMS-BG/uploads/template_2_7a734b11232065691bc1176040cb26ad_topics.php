...
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->reputation( $comment, 'ipsResponsive_noFloat' );
$return .= <<<CONTENT
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=members&controller=profile&id={$comment->author()->member_id}-{$comment->author()->name}", null, "profile", array( $seoName ), 0 ) );
$return .= <<<CONTENT
" data-ipshover data-ipshover-target="
CONTENT;

$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=members&controller=profile&id={$comment->author()->member_id}-{$comment->author()->name}&do=hovercard", null, "profile", array( $seoName ), 0 ) );
$return .= <<<CONTENT
" title="
CONTENT;
...
uploads/
CONTENT;
$return .= htmlspecialchars( $comment->author()->pp_main_photo, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
"></span>
                  </a>
...
">
                          <span class="ipsUserPhoto ipsUserPhoto_variable">
                                  <img src="&lt;Path_to&gt;/default_photo.png"></span>
                  </a>
...
$return .= <<<CONTENT
	...
	<div class='ipsColumns questionsHeader'>
...
$return .= <<<CONTENT
		...
		<div class='ipsPad_half ipsPos_left ipsType_light ipsResponsive_hidePhone ipsfocus_rating'>
...
<div data-controller='core.front.core.commentFeed,forums.front.topic.view' 
CONTENT;
...
if ( !\IPS\Theme::i()->settings['simpleTopicLayout'] ):
$return .= <<<CONTENT
...
if ( !\IPS\Theme::i()->settings['ipsf_lightButtonBar'] ):
$return .= <<<CONTENT
ipsButtonBar
CONTENT;
...
$return .= <<<CONTENT
 ipsPad_half ipsClearfix ipsClear 
CONTENT;
...
if ( \IPS\Theme::i()->settings['simpleTopicLayout'] ):
$return .= <<<CONTENT
<span class='ipsPos_right focusPostCount' data-role="comment_count" data-commentCountString="js_num_topic_posts">
CONTENT;
...
$return .= <<<CONTENT
					...
					<p class='ipsType_center ipsType_light ipsType_large ipsPad ipsPos_center' data-role="noComments">
...
$return .= <<<CONTENT
		...
		<a id='replyForm'></a>
		<div data-role='replyArea' class='cTopicPostArea ipsBox ipsBox_transparent ipsAreaBackground_reset ipsPad 
CONTENT;
...
$sprintf = array($topic->container()->_title); $return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'go_to_forum', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), FALSE, array( 'sprintf' => $sprintf ) );
$return .= <<<CONTENT
" rel="up">
