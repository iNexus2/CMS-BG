...
$return .= <<<CONTENT
	    ...
	    <aside class="ipsComment_author cAuthorPane ipsColumn ipsColumn_medium"><h3 class="ipsType_sectionHead cAuthorPane_author ipsType_blendLinks ipsType_break" itemprop="creator" itemscope itemtype="http://schema.org/Person"><strong itemprop="name">{$comment->author()->link( $comment->warningRef() )}</strong></h3>
...
if ( \IPS\Settings::i()->bd_moods_displaypos==0 ):
$return .= <<<CONTENT
mood-top-left
                
CONTENT;

elseif ( \IPS\Settings::i()->bd_moods_displaypos==1 ):
$return .= <<<CONTENT
mood-top-right
                
CONTENT;

elseif ( \IPS\Settings::i()->bd_moods_displaypos==2 ):
$return .= <<<CONTENT
mood-bottom-right         
                
CONTENT;

elseif ( \IPS\Settings::i()->bd_moods_displaypos==3 ):
$return .= <<<CONTENT
mood-bottom 
                
CONTENT;

elseif ( \IPS\Settings::i()->bd_moods_displaypos==4 ):
$return .= <<<CONTENT
mood-bottom-left
...
$return .= \IPS\bdmoods\Mood::load($comment->author()->bdm_mood)->get_image($comment->author()->get_moodTitle());
$return .= <<<CONTENT
</div>
CONTENT;
...
$return .= <<<CONTENT
			...
			<hr class="aupHr">
<li class="aupBorder">
			    <span class="aupTitle"><i class="fa fa-users" aria-hidden="true"></i> 
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'User_Group', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
:</span>
				<span class="aupContent">
CONTENT;
...
$return .= <<<CONTENT
				...
				<li class="ipsType_break aupBorder">
				    <span class="aupTitle"><i class="fa fa-star" aria-hidden="true"></i> 
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'Member_Title', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
:</span>
				    <span class="aupContent">
CONTENT;
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'Member_Rank', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
:</span>
				    <span class="aupContent">
CONTENT;
...
$return .= <<<CONTENT
			...
			<hr class="aupHr">
<li class="aupBorder">
			    <span class="aupTitle"><i class="fa fa-id-card-o" aria-hidden="true"></i> 
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'Member ID', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
:</span>
				<span class="aupContent">
CONTENT;
...
$return .= <<<CONTENT
			...
			<hr class="aupHr">
<li class="ipsType_break aupBorder">
                <span class="aupTitle"><i class="fa fa-smile-o" aria-hidden="true"></i> 
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'User_Mood', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
:</span>
                <span class="aupContent">
CONTENT;
$return .= htmlspecialchars( $comment->author()->get_moodTitle(), ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
</span>
            </li> 
			<br>
...
$return .= <<<CONTENT
			...
			<hr class="aupHr">
<li class="aupBorder">
			    <span class="aupTitle"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'Content_Count', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
:</span>
				<span class="aupContent">
CONTENT;
...
$return .= <<<CONTENT
			...
			<hr class="aupHr">
<li class="aupBorder">
			    <span class="aupTitle"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'Total_Rep', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
:</span>
				<span class="aupContent">
CONTENT;
...
$return .= <<<CONTENT
			...
			<hr class="aupHr">
<li class="ipsType_break aupBorder">
				<span class="aupTitle"><i class="fa fa-calendar-o" aria-hidden="true"></i> 
CONTENT;
...
$val = ( $comment->author()->joined instanceof \IPS\DateTime ) ? $comment->author()->joined : \IPS\DateTime::ts( $comment->author()->joined );$return .= (string) $val->localeDate();
$return .= <<<CONTENT
</span>
			</li>
			<br>
...
$return .= <<<CONTENT
			...
			<hr class="aupHr">
<li class="ipsType_break aupBorder">
				<span class="aupTitle"><i class="fa fa-bell-o" aria-hidden="true"></i> 
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'Online_Status', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
:</span>
		        <span class="aupContent">
CONTENT;
...
$return .= <<<CONTENT
            ...
            <hr class="aupHr">
<li class="ipsType_break aupBorder">
				<span class="aupTitle"><i class="fa fa-trophy" aria-hidden="true"></i> 
CONTENT;
...
$return .= \IPS\Member::loggedIn()->language()->formatNumber( $comment->author()->getReputationDaysWonCount() );
$return .= <<<CONTENT
</span>
			</li>
			<br>
