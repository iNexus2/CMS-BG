...
$return .= <<<CONTENT
				...
				<ul data-role="saveButtonContainer" class='ipsList_inline ipsSpacer_top ipsSpacer_half ipsHide ipsType_right ipsType_small ipsAreaBackground_light ipsPad_half'> 
					<li>
CONTENT;
...
CONTENT;
$return .= htmlspecialchars( $stream->read, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
" 
CONTENT;
	...
	<div class='ipsBox ipsPad'>
		<ul class="ipsButtonRow ipsPos_right ipsClearfix">
			<li>
				<a href="
CONTENT;
$return .= htmlspecialchars( $stream->baseUrl->setQueryString( 'view', 'condensed'), ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'stream_results_as_condensed', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a>
			</li>
			<li>
				<a href="
CONTENT;
$return .= htmlspecialchars( $stream->baseUrl->setQueryString( 'view', 'expanded'), ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'stream_results_as_expanded', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</a>
			</li>
			<li>
				<span class="ipsButtonRow_noBackground">
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'stream_results_as', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</span>
			</li>
		</ul>
...
$return .= <<<CONTENT
		...
		<div data-role='streamBody' style='margin-top: 10px'>
			{$html}
		</div>
	</div>
