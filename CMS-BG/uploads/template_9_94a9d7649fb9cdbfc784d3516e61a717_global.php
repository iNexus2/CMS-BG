...
if ( \IPS\Theme::i()->settings['ipsf_advancedBreadcrumb'] ):
$return .= <<<CONTENT
class='ipsfocus_breadcrumb'
CONTENT;
...
$return .= <<<CONTENT
		...
		<main role="main" id="ipsLayout_body" class="ipsLayout_container"><div class="contentContainer">
...
if ( \IPS\Theme::i()->settings['globalMessage'] ):
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->ipsfocus_globalMessage(  );
endif;
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ifBg1_image'] ):
$return .= <<<CONTENT
background-image: url(
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg1_image'];
$return .= <<<CONTENT
);
CONTENT;
...
$return .= \IPS\Theme::i()->settings['ifBg1_position'];
$return .= <<<CONTENT
; background-size: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg1_size'];
$return .= <<<CONTENT
'></span>
...
if ( \IPS\Theme::i()->settings['ifBg2_image'] ):
$return .= <<<CONTENT
background-image: url(
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg2_image'];
$return .= <<<CONTENT
);
CONTENT;
...
$return .= \IPS\Theme::i()->settings['ifBg2_position'];
$return .= <<<CONTENT
; background-size: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg2_size'];
$return .= <<<CONTENT
'></span>
...
if ( \IPS\Theme::i()->settings['ifBg3_image'] ):
$return .= <<<CONTENT
background-image: url(
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg3_image'];
$return .= <<<CONTENT
);
CONTENT;
...
$return .= \IPS\Theme::i()->settings['ifBg3_position'];
$return .= <<<CONTENT
; background-size: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg3_size'];
$return .= <<<CONTENT
'></span>
...
if ( \IPS\Theme::i()->settings['ifBg4_image'] ):
$return .= <<<CONTENT
background-image: url(
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg4_image'];
$return .= <<<CONTENT
);
CONTENT;
...
$return .= \IPS\Theme::i()->settings['ifBg4_position'];
$return .= <<<CONTENT
; background-size: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg4_size'];
$return .= <<<CONTENT
'></span>
      	<span data-backgroundClass='ipsfocus_bg5' style='background-color: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg5_hex'];
$return .= <<<CONTENT
; 
CONTENT;

if ( \IPS\Theme::i()->settings['ifBg5_image'] ):
$return .= <<<CONTENT
background-image: url(
CONTENT;
...
$return .= \IPS\Theme::i()->settings['ifBg5_position'];
$return .= <<<CONTENT
; background-size: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg5_size'];
$return .= <<<CONTENT
'></span>
      	<span data-backgroundClass='ipsfocus_bg6' style='background-color: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg6_hex'];
$return .= <<<CONTENT
; 
CONTENT;

if ( \IPS\Theme::i()->settings['ifBg6_image'] ):
$return .= <<<CONTENT
background-image: url(
CONTENT;
...
$return .= \IPS\Theme::i()->settings['ifBg6_position'];
$return .= <<<CONTENT
; background-size: 
CONTENT;

$return .= \IPS\Theme::i()->settings['ifBg6_size'];
$return .= <<<CONTENT
'></span>
	</div>
</div>
...
CONTENT;
	...
	function ipsfocus_globalMessage(  ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['globalMessageClass'];
$return .= <<<CONTENT
 ipsfocus_globalMessage 
CONTENT;

if ( !\IPS\Theme::i()->settings['globalDismiss'] ):
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->settings['globalMessageText'];
$return .= <<<CONTENT
...
<ul class="ipsList_inline">
        <li>
            <a href="#" class="ipsButton ipsButton_small ipsfocus_dismissGlobalMessage">Dismiss</a>
        </li>
    </ul>
CONTENT;
...
$return .= \IPS\Theme::i()->settings['ipsf_socialContent'];
$return .= <<<CONTENT
...
$return .= \IPS\Settings::i()->base_url;
$return .= <<<CONTENT
' id='elLogo' accesskey='1' class='logo hideOnMobile'><img src="
CONTENT;
...
$return .= \IPS\Settings::i()->base_url;
$return .= <<<CONTENT
' id='elSiteTitle' accesskey='1' class='logo textLogo hideOnDesktop'>
			<span>
				
CONTENT;

if ( \IPS\Theme::i()->settings['customLogoText'] ):
$return .= <<<CONTENT

CONTENT;

$return .= \IPS\Theme::i()->settings['customLogoText'];
$return .= <<<CONTENT
...
$return .= \IPS\Settings::i()->base_url;
$return .= <<<CONTENT
' id='elLogo' accesskey='1' class='logo'><img src="
CONTENT;
$return .= htmlspecialchars( $logo, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
" alt='
...
$return .= \IPS\Settings::i()->base_url;
$return .= <<<CONTENT
' id='elSiteTitle' accesskey='1' class='logo textLogo'>
...
if ( (\IPS\Theme::i()->settings['ipsf_christmas']) OR (\IPS\Theme::i()->settings['ipsf_valentines'])  ):
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['ipsf_pickerMobile']  ):
$return .= <<<CONTENT
...
$return .= <<<CONTENT
							...
							<li><a href='
CONTENT;
$return .= htmlspecialchars( $review->url('delete')->csrf(), ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE );
$return .= <<<CONTENT
' data-confirm data-action='deleteComment' data-updateOnDelete="#commentCount" class='ipsButton ipsButton_verySmall ipsButton_negative'><i class='fa fa-times'></i> 
CONTENT;
...
$return .= <<<CONTENT
	...
	<div id='searchWrap'>
		<div id='elSearch' data-controller='core.front.core.quickSearch' itemprop="potentialAction" itemscope itemtype="http://schema.org/SearchAction" data-default="
CONTENT;
