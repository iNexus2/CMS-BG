...
<section class='ipsPad'>
	<br>
	<div class='ipsBox ipsPad'><h1 class='ipsType_veryLarge ipsType_center ipsType_reset'>
CONTENT;
...
<div class='ipsBox ipsfocus_reset cFollowedContent'>
...
<div class='ipsLayout_contentSection ipsBox'>
...
<div class='ipsBox' id='elSettingsTabs' data-ipsTabBar data-ipsTabBar-contentArea='#elProfileTabContent' data-ipsTabBar-itemSelector='.ipsSideMenu_item' data-ipsTabBar-activeClass='ipsSideMenu_itemActive'>
...
$return .= str_replace( '&', '&amp;', \IPS\Http\Url::internal( "app=core&module=system&controller=settings&area=securityquestions", null, "settings_securityquestions", array(), 0 ) );
$return .= <<<CONTENT
' id='setting_securityquestions' class='ipsType_normal ipsSideMenu_item 
CONTENT;

if ( $tab === 'securityquestions' ):
$return .= <<<CONTENT
ipsSideMenu_itemActive
CONTENT;
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'security_questions', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
" role="tab" aria-selected="
CONTENT;
