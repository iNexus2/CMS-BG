...
foreach ( explode(',',\IPS\Theme::i()->settings['veilon_nodes_select_icon_redirect']) as $key => $icon ):
$return .= <<<CONTENT
...
foreach ( explode(',',\IPS\Theme::i()->settings['veilon_nodes_select_icon_question']) as $key => $icon ):
$return .= <<<CONTENT
...
foreach ( explode(',',\IPS\Theme::i()->settings['veilon_nodes_select_icon_unlock']) as $key => $icon ):
$return .= <<<CONTENT
...
foreach ( explode(',',\IPS\Theme::i()->settings['veilon_nodes_select_icon_lock']) as $key => $icon ):
$return .= <<<CONTENT
...
foreach ( explode(',',\IPS\Theme::i()->settings['veilon_nodes_select_icon']) as $key => $icon ):
$return .= <<<CONTENT
...
foreach ( explode(',',\IPS\Theme::i()->settings['veilon_subforum_icon']) as $key => $icon ):
$return .= <<<CONTENT
