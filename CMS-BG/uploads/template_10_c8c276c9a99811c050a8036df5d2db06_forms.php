...
foreach ( explode(',',\IPS\Theme::i()->settings['veilon_compose_icon_select']) as $key => $icon ):
$return .= <<<CONTENT
...
$return .= <<<CONTENT
. &nbsp;&nbsp;<a class='ipsType_blendLinks ipsCursor_pointer' data-action="keepPasteFormatting">
CONTENT;
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'editor_pasted_with_formatting', \IPS\HTMLENTITIES, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
. &nbsp;&nbsp;<a class='ipsType_blendLinks ipsCursor_pointer' data-action="removePasteFormatting">
CONTENT;
...
$return .= <<<CONTENT
. &nbsp;&nbsp;<a class='ipsType_blendLinks ipsCursor_pointer' data-action="removeEmbeddedMedia">
CONTENT;
