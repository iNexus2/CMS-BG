...
$return .= <<<CONTENT
	...
	<div id='veilonCopyright'>Design with <a href="https://veilon.net">Veilon.Net</a>
</ul>	
...
$return .= \IPS\Theme::i()->getTemplate( "_veilon", "core" )->_veilon_slider(  );
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "_veilon", "core" )->_veilon_guestmessage(  );
endif;
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['veilon_footer'] ):
$return .= \IPS\Theme::i()->getTemplate( "_veilon", "core" )->_veilon_footer(  );
endif;
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['veilon_footer'] ):
$return .= \IPS\Theme::i()->getTemplate( "_veilon", "core" )->_veilon_js_body(  );
endif;
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "_veilon", "core", 'front' )->_veilon_navbaritems( \IPS\core\FrontNavigation::i()->roots( $preview ), \IPS\core\FrontNavigation::i()->subBars( $preview ), 0, $preview );
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['veilon_view_create_new_content'] ):
$return .= <<<CONTENT
